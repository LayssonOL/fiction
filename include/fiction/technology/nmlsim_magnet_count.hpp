//
// Created by layssonol on 10.04.23.
//
...
uint64_t nmlsim_magnet_count(const Lyt& lyt) noexcept
{
    static_assert(is_cell_level_layout_v<Lyt>, "Lyt is not a cell-level layout");
    static_assert(has_nmlib_inml_technology_v<Lyt>, "Lyt is not an iNML layout");
    ...
    lyt.foreach_cell(
        ...
        {
            if (lyt.get_cell_type(c) == nmlib_inml_technology::cell_type::INVERTER_MAGNET)
            {
                ++num_inv_cells;
            }
        });
