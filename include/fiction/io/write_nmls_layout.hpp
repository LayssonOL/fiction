...
inline constexpr const char* NMLS_HEADER = "LLG;verbose;RK4;100;0.1;0.05;800000;300;0.001;55;0.4;3.5;5;300;";
...
inline constexpr const char* MAGNET_SPECS = // Magnet_{ID};magnet_type;clock_zone;magnetization_vector;fixed_magnetization;width;height;thickness;0;0;pos_x,pos_y;color_code
  "Magnet_{};{};{};{};{};{};{};{};{};{};{};{}";
...
class write_nmls_layout_impl
{
  ...
  private:
    ...
    void write_header()
    {
        os << fmt::format(nmls::VERSION_HEADER, FICTION_VERSION, FICTION_REPO);
        os << fmt::format(nmls::OPEN_QCA_COMPONENT, tech_impl_name<technology<Lyt>>, nmls::LIBRARY_NAME,
